import { TaskCompletionDetails } from './completionTemplates.js';
 ...
 */
export function parseCompletionSummary(summary: string): TaskCompletionDetails {
 ...
 */
function extractVerificationScore(text: string): number {
 ...
 */
export function parseFlexibleSummary(summary: string): TaskCompletionDetails {
