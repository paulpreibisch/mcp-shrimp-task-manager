...
function ArchiveView({ 
  ...
  ], [onViewArchive, onDeleteArchive, onImportArchive]);
  ...
  if (archives.length === 0) {
    return (
      <div className="empty-state" style={{ 
        ...
        No archived task lists found
      </div>
    );
  }

  return (
    <div className="archive-view" style={{ padding: '20px' }}>
      <div className="archive-view-header" style={{ marginBottom: '20px' }}>
        <h2 style={{ 
          margin: 0,
          color: '#8b5cf6',
          display: 'flex',
      ...
      <div className="pagination" style={{
        ...
        <div className="pagination-info" style={{
          ...
          of {table.getFilteredRowModel().rows.length} archives
        </div>
